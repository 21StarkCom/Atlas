...
| `install-artifact.sh` | Hash-verified install of built privileged binaries into the root-owned `installBin`; records `<bin>.installed.sha256` for `provisioning.integrity.test`. |
