...
- **ADRs** are monotonic `NNNN-<topic>.md`, MADR-lite, **immutable — supersede, don't edit**. Three exist: `0001` (egress scan) and `0002` (P-256/SE signer) are **superseded by `0003`**; `0003` (`Status: accepted`) is the v2 pivot and is current.
