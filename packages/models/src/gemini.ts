...
export interface ProviderAdapter {
   ...
   */
  serialize(operation: ProviderOperation, request: GenerateTextRequest | GenerateObjectRequest | EmbedRequest): SerializedRequest;
  /**
...
function allowlistFor(operation: ProviderOperation): ReadonlySet<string> {
